...
| # | Arquivo | Entrega |
|---|---|---|
| 1 | `01_Phase0_Setup_and_Architecture.md` | Ambiente IRIS, namespace, arquitetura proposta |
| 2 | `02_Phase1_Production_COS.md` | Service → Process → Operation, mensagem real, falha/recuperação |
| 3 | `03_Phase2_Production_Monitor.md` | Dashboard de saúde da Production |
| 4 | `04_Phase3_RAG_Assistant.md` | Ingestão, embeddings, geração com citação, abstenção |
| 5 | `05_Phase4_AI_Incident_Investigator.md` | Evidência real + análise de IA |
| 6 | `06_Bonus_Business_Rules_and_Hybrid_Search.md` | Roteamento por regra visual + busca híbrida |
| 7 | `07_Bonus_Public_API_PublicHealth.md` | Segunda Production consumindo API pública real |
| 8 | `08_Bonus_Multimodel_Groq.md` | Segundo provedor de IA (Groq) na geração |
| 9 | `09_Phase5_Hardening_Installation_Tests.md` | Instalação limpa, testes formais, auditoria |
| 10 | `10_Phase5b_UX_Loading_and_I18n.md` | Overhaul do indicador de carregamento e cobertura completa de i18n |
| 11 | `11_Persistent_Sidebar_Redesign.md` | Barra lateral persistente com saúde da Production sempre visível (aplica-se depois dos itens 3-5) |
