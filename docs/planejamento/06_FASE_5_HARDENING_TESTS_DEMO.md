...
| 8 | Gravação do vídeo | **Roteiro operacional criado 14/09/2026** (`08_ROTEIRO_GRAVACAO_VIDEO.md`) — passo a passo para o proprietário gravar sozinho (subir app, gerar falha controlada, monitorar, investigar, perguntar aos dois RAG, recuperar). Gravação em si ainda não feita |
